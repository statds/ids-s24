...
```{python}
(ggplot(data_used, aes(x='created_date', fill = 'borough')) # Add color coded descriptors.
...
```{python}
(ggplot(data_used, aes(x='created_date', color = 'descriptor')) #Add color coded descriptors.
    + geom_density()
    + theme(axis_text_x=element_text(angle=45)) # Change the orientation of the words.
)
```
