...
print('test statistic:', results_4_2.statistic)
print('p-value:', results_4.pvalue)
print('degrees of freedom:', results_4_2.dof) 
``` 
At an alpha level of $0.05$, the p-value allows us to reject the null hypothesis
...
**Assumptions:** Observations are i.i.d., ordinal, and the samples are paired.
...
is stochasitcally greater than the distribution of response times for 2023. 
