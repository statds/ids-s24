...
```{python}
results_chi2_2 = scipy.stats.chi2_contingency(freq_table_2)

print('test statistic:', results_chi2_2.statistic)
print('p-value:', results_chi2_2.pvalue)
print('degrees of freedom:', results_chi2_2.dof) 
``` 
At an alpha level of $0.05$, the p-value allows us to reject the null hypothesis
