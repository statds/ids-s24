...
+ Wu, Weijia 
    - Get to know with github and get better with python skills
    - Developed a data-science project
+ Xie, Vincent
...
Please use the following table to sign up.
  ...
  02/07  | Weijia Wu              | Data Visualization
  ...
  03/02  | David Li               |
  03/04  | Abigail Mori           | Handling spatial data with `geopandas`
