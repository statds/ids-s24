...
There are ___ jobs nested inside our original "table" HTML element. Let's take a closer look at the structure of this element, to get a more concrete example of what we want to scrape.
