...
official documentation by visiting [https://www.statsmodels.org/stable/index.html](https://www.statsmodels.org/stable/index.html). If you are working in a code editor, you can also run 
the following:
```{python}
sm.webdoc() 
