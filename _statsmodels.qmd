...
count of Sunspot activity (`SUNACTIVITY`) by a small amount. 
...
A larger deviance indicates a worse fit for the model.
...
```{python}
result3.null_deviance
result3.resid_deviance
result3.pearson_chi2
```
...
* Diagnostic tests:
    ...
    + [https://www.statology.org/null-residual-deviance/#:~:text=The%20null%20deviance%20tells%20us%20how%20well%20the,to%20predict%20the%20value%20of%20the%20response%20variable.]
