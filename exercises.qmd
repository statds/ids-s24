...
1. **Git basics and GitHub setup**
  ...
  status of your repo using `git status`. The specific tasks are:
    ...
    1. Add all the files to your designated homework repo from GitHub Classroom and work on that repo for the rest of the problem.
  ...
  commit.
    ...
    1. Put the repo into the GitHub Classroom homework repo with `git
