...
for the legend function from the Matplotlib library. This documentation includes a description of what the function does, the parameters it accepts, and other relevant information such as return values and examples of how to use the function.
...
`'count' `means it will count the occurrences of each category combination and display this as bars in the plot.
...
```{python}
sns.catplot(x='Gender', y='Grades', col='Class', 
data=df4, kind='box', height = 10, col_wrap=2)
```
